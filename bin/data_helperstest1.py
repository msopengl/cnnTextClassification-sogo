...
def load_data_and_labels():
    ...
    positive_examples = list(open("./tmp/data.image.query.seg.train", "r").readlines())
    positive_examples = [s.strip() for s in positive_examples]
    negative_examples = list(open("./tmp/data.web.query.seg.train", "r").readlines())
...
def get_voc(filename="./data/all.image.bin", dim=100):
...
def data_iter(idmap, batchsize=64, num_epochs=1, filename="./tmp/all.image"):
    batch = []
